...
class _AddHourlyServiceState extends State<AddHourlyService> {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        if (isDesktop || isTablet) {
          return _buildWebLayout(context, eventsCount, slots, isDesktop);
        }
        return _buildMobileLayout(context, eventsCount, slots);
      },
    );
  }

  Widget _buildWebLayout(BuildContext context, int eventsCount, List<Map<String, String>> slots, bool isDesktop) {
    return Scaffold(
                        ...
                        Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // Venue Type (for Venues only)
                              if (widget.category == "Venues") ...[
                                _buildWebSectionCard(
                                  title: "Venue Type",
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Expanded(
                                          child: _buildWebSelectionCard(
                                            title: "Indoor",
                                            subtitle: "Inside venue",
                              ...
                              _buildWebSectionCard(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Expanded(child: _buildWebTimePicker("From", _from, _pickFrom)),
                                      const SizedBox(width: 16),
                                      Expanded(child: _buildWebTimePicker("To", _to, _pickTo)),
                                    ],
                                  ),
                                  const SizedBox(height: 24),
                                  Text(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text("Hours Range", style: GoogleFonts.poppins(fontSize: 12, color: _kTextSecondary)),
                                            const SizedBox(height: 8),
                                            RangeSlider(
                                              values: _hoursRange,
                                              min: 1,
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          "${_hoursRange.start.round()} - ${_hoursRange.end.round()} hrs",
                                          style: GoogleFonts.poppins(
                                            fontSize: 13,
                                            fontWeight: FontWeight.w700,
                            ...
                            children: [
                                  ...
                                  if (_finalPrice != null) ...[
                                    ...
                                    if (_savedAmount != null && _savedAmount! > 0)
                                      Padding(
                                        ...
                                        child: Text(
                                          "Customers save ${_savedAmount!.toStringAsFixed(2)} ₪",
                                          style: GoogleFonts.poppins(
                                            fontSize: 12,
                              ...
                              _buildWebSectionCard(
                                ...
                                children: [
                                    ...
                                    children: [
                                      Expanded(
                                        child: Slider(
                                          ...
                                          onChanged: (v) {
                                            setState(() {
                                              _gapMinutes = ((v / 5).round() * 5).toDouble().clamp(0, 180);
                                            });
                                          },
                                        ),
                                      ),
                                      Container(
                                        ...
                                        child: Text(
                                          _gapMinutes == 0 ? "None" : "${_gapMinutes.round()} min",
                                          style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w700, color: _kPrimaryColor),
                                        ),
                                      ),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      _buildWebInfoPill(LucideIcons.calendar, "$eventsCount/day"),
                                      const SizedBox(width: 10),
                                      _buildWebInfoPill(LucideIcons.clock, "${minHoursCtrl.text}h each"),
                                    ],
                                  ),
                                  if (slots.isNotEmpty) ...[
                                    const SizedBox(height: 16),
                                    Text("Suggested Slots", style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w600)),
                                    const SizedBox(height: 10),
                                    Wrap(
                                      spacing: 8,
                                      runSpacing: 8,
                                      children: slots.take(8).map((s) {
                                        final key = _slotKey(s);
                                        final selected = _selectedSuggestedSlots.contains(key);
                                        return InkWell(
                                          onTap: () {
                                          ...
                                          child: Container(
                                            padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                                            decoration: BoxDecoration(
                                              color: selected ? _kPrimaryColor : _kPrimaryLight.withOpacity(0.5),
                                              borderRadius: BorderRadius.circular(20),
                                            ),
                                            child: Text(
                                              '${s["start"]} - ${s["end"]}',
  ...
  Widget _buildWebTimePicker(String label, TimeOfDay? time, VoidCallback onTap) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            const Icon(LucideIcons.clock, color: _kPrimaryColor, size: 20),
            const SizedBox(width: 10),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(label, style: GoogleFonts.poppins(fontSize: 11, color: _kTextSecondary)),
                  Text(
                    _fmtTime(time),
            ...
            const Icon(LucideIcons.chevronDown, color: _kTextSecondary, size: 18),
          ],
        ),
      ),
    );
  ...
  Widget _buildWebInfoPill(IconData icon, String text) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: 14, color: _kPrimaryColor),
          const SizedBox(width: 6),
          Text(
            text,
            style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w600, color: _kPrimaryColor),
          ),
        ],
      ),
    );
  ...
  Widget _buildMobileLayout(BuildContext context, int eventsCount, List<Map<String, String>> slots) {
    return Scaffold(
